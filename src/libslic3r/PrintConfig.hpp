...
enum ExcludePrintSpeedsAdjustmentDirection { epsdLowest, epsdHighest, epsdNearest };
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat, aux_fan_kickstart))
    ((ConfigOptionBool, aux_fan_percentage))
    ((ConfigOptionInt, aux_fan_printer_min_speed))
    ((ConfigOptionBool, aux_fan_speedup_overhangs))
    ((ConfigOptionFloat, aux_fan_speedup_time))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionInts, default_aux_fan_speed))
    ((ConfigOptionInts, external_perimeter_aux_fan_speed))
    ((ConfigOptionFloats, aux_fan_below_layer_time))
    ((ConfigOptionInts, full_aux_fan_speed_layer))
    ((ConfigOptionInts, gap_fill_aux_fan_speed))
    ((ConfigOptionInts, infill_aux_fan_speed))
    ((ConfigOptionInts, internal_bridge_aux_fan_speed))
    ((ConfigOptionGraphs, overhangs_dynamic_aux_fan_speed))
    ((ConfigOptionInts, overhangs_aux_fan_speed))
    ((ConfigOptionInts, perimeter_aux_fan_speed))
    ((ConfigOptionInts, solid_infill_aux_fan_speed))
    ((ConfigOptionInts, support_material_aux_fan_speed))
    ((ConfigOptionInts, support_material_interface_aux_fan_speed))
    ((ConfigOptionInts, top_aux_fan_speed))(
